...
> **Audience**: Composer developers implementing hardware access for YoshiPi
>
...
| Operation | CCS Module | Linux Interface |
|-----------|--------------|-----------------|
...
**Key Advantage**: All of this is standard Linux programming. The same Composer compiler, same CCS intrinsics, same patterns as desktop - just different device paths and ioctl constants.
