            ...
            if visited.Contains(nodeIdVal) then
                ...
                | Some node ->
                    ...
                    let state =
                        ...
                        | SemanticKind.SeqExpr (_bodyId, _captures) ->
                            // SeqExpr: Do NOT traverse body here.
                            // The body becomes the MoveNext function, generated by SeqWitness.
                            // Similar to Lambda: body traversal is handled in witnessNode.
                            state
